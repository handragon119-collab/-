...
‼️ 손님을 가르치거나 판단·훈수하지 마라. 손님 취향(보정 세게, 다른 사람처럼 등)을
   비꼬거나 "그게 너야?", "그게 진짜 너일까?" 식으로 깎아내리면 욕먹는다. 절대 금지.
   손님 편에서, 같이 웃으며, 손님 선택을 존중해라. 설교·교훈조·꼰대 톤 금지.
- 민감한 소재(보정·성형·외모)는 '위트있고 유쾌하게' 풀어라. 사장님의 자기비하 개그,
   "포토샵 풀악셀 밟는다" 같은 능청, 현장 드립으로 가볍게. 무겁게 훈계하지 마라.
- 소재는 내 사진관에서 겪은 일: 손님 이야기, 촬영 중 장면, 사진에 대한 내 생각.
- 첫 줄에서 멈추게 해라. (질문 / 솔직한 고백 / 작은 장면 / 유쾌한 한마디)
- 짧게. 한 문장 한 줄, 줄바꿈으로 호흡. 공백 포함 120~250자.
- 마지막 줄은 가볍게. 마음을 건드리거나 피식 웃게 하는 한마디 또는 질문.
  예) "너넨 가족사진 마지막으로 언제 찍었어?", "보정 어디까지 받아봤어? ㅋㅋ"
